...
// ========================
export const createBusinessGroup = async (req, res) => {
    try {
...
// Get All Groups
// ========================
export const getBusinessGroups = async (req, res) => {
    try {
...
// Get Single Group
// ========================
export const getBusinessGroupById = async (req, res) => {
    try {
        const { id } = req.params;
        const groupId = id;
...
// ========================
export const updateBusinessGroup = async (req, res) => {
    try {
...
// ========================
export const deleteBusinessGroup = async (req, res) => {
    try {
        const { id } = req.params;
        const groupId = id;
        if (!mongoose.Types.ObjectId.isValid(groupId))
...
// ========================
export const removeBusinessMember = async (req, res) => {
    try {
        const { groupId, userId } = req.body;
        if (!mongoose.Types.ObjectId.isValid(groupId) || !mongoose.Types.ObjectId.isValid(userId))
            return res.status(400).json({ message: "Invalid IDs" });
