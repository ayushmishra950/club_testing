...
export const registerUser = async (req, res) => {
    try {
        ...
        await createNotificationInternal(user._id, user._id, NotificationType.NEW_USER, undefined, "New member registered. Please check member list.");
...
export const updateUser = async (req, res) => {
    try {
        ...
        const incomingBusinesses = incomingBusinessesRaw.filter((biz) => {
            return (biz &&
        ...
        // ================= MAP BUSINESSES =================
        const parsedBusinesses = incomingBusinesses.map((biz) => {
            ...
            return {
                ...
                businessCoverImage: typeof biz.businessCoverImage === "string"
...
export const convertPremiumUser = async (req, res) => {
    try {
