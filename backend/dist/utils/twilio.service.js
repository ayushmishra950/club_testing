...
if (!ACCOUNT_SID || !TWILIO_AUTH_TOKEN || !TWILIO_PHONE_NUMBER)
    throw new Error("account sid, api key secret, or twilio number is required.");
...
/* ================= SEND WELCOME SMS ================= */
export const sendWelcomeSMS = async (phone, fullName, password) => {
    const message = `
Welcome ${fullName} 🎉
