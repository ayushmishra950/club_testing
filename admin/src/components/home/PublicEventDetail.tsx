...
//           <div
//             className={`
//     mt-3 px-4 py-1 rounded-full text-sm font-medium backdrop-blur-sm
//     ${isPastEvent
...
export default function PublicEventDetail() {
  ...
  // ================= IMAGES =================
  const images = Array.isArray(event?.coverImage)
    ? event?.coverImage
    : [event?.coverImage];
  ...
  const isPastEvent =
    eventDate.getTime() < now.getTime() && !isToday;
  ...
  const statusClasses = useMemo(() => {
    ...
    if (isToday) {
      return "bg-red-500/20 text-red-300 border border-red-400/20 animate-pulse";
    }
    ...
    <div className="w-full overflow-hidden">
      ...
      <div className="relative h-screen w-full overflow-hidden">
        ...
        <div
          className={`
            ...
            ${isPastEvent ? "bg-black/70" : "bg-black/60"}
          `}
        />
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          <div
            className={`
              px-4 py-1 rounded-full text-sm font-medium backdrop-blur-sm mb-5
              ${statusClasses}
            `}
          >
            {eventStatus}
      ...
      {!isPastEvent ? (
        ...
        <div className="py-20 bg-white text-center">
          ...
          <p className="text-muted-foreground mt-3 mb-12">
            The excitement is building up — reserve your spot now.
          </p>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-5 max-w-4xl mx-auto px-4">

            <div className="p-8 border rounded-2xl shadow-sm bg-white hover:shadow-md transition">
        ...
        <div className="py-24 bg-black text-white text-center px-4">
          ...
          <p className="text-white/70 mt-5 max-w-2xl mx-auto leading-relaxed">
            ...
            We hope you enjoyed every moment and created unforgettable memories.
          </p>
      ...
      <div className="py-20 max-w-6xl mx-auto px-4 text-center">
        ...
        <p className="text-muted-foreground mt-3">
          {isPastEvent
            ? "Relive the unforgettable memories"
            : "Experience unforgettable moments"}
        </p>

        <div className="mt-12 grid md:grid-cols-2 gap-10 items-center text-left">
                ...
                (media, index) => {
                  ...
                  return (
                    ...
                    <div
                      ...
                      className="h-72 rounded-2xl overflow-hidden bg-black/10 shadow-sm hover:shadow-lg transition"
                    >
      ...
      {!isPastEvent && (
        ...
        <div className="py-20 bg-white text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12 max-w-6xl mx-auto px-4">
            ...
            {/* CARD 1 */}
            <div className="p-6 border rounded-2xl bg-white shadow-sm hover:shadow-md transition text-left">
              ...
              <p className="text-sm text-muted-foreground mt-3 leading-relaxed">
                Includes husband and wife annual participation.
              </p>
            </div>
            ...
            <div className="p-6 border rounded-2xl bg-white shadow-sm hover:shadow-md transition text-left">
              ...
              <p className="text-sm text-muted-foreground mt-3 leading-relaxed">
                One-time onboarding charge for new members.
              </p>
            </div>
            ...
            <div className="p-6 border rounded-2xl bg-white shadow-sm hover:shadow-md transition text-left">
              ...
              <p className="text-sm text-muted-foreground mt-3 leading-relaxed">
                Kids are welcome in family activities and programs.
              </p>
            </div>
            ...
            <div className="p-6 border rounded-2xl bg-white shadow-sm hover:shadow-md transition text-left">
              ...
              <p className="text-sm text-muted-foreground mt-3 leading-relaxed">
                Applicable for early registrations before deadline.
              </p>
            </div>
